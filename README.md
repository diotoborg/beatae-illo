[![Build Status](https://travis-ci.com/diotoborg/beatae-illo.svg?branch=main)](https://travis-ci.com/diotoborg/beatae-illo)
...
[![Maintainability](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/maintainability)](https://codeclimate.com/github/diotoborg/beatae-illo/maintainability)
[![Test Coverage](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/test_coverage)](https://codeclimate.com/github/diotoborg/beatae-illo/test_coverage)
...
```javascript
var languages = require("@diotoborg/beatae-illo");

// Support german & english languages.
languages.registerLocale(require("@diotoborg/beatae-illo/langs/en.json"));
languages.registerLocale(require("@diotoborg/beatae-illo/langs/de.json"));
```
